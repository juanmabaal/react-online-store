    ...
    return (
        <div className='bg-white cursor-pointer w-45 h-55 rounded-lg border border-gray-300 border-line p-1'>
            <figure className='relative mb-2 w-full h-4/5'>
                ...
                <div className='absolute top-0 right-0 flex justify-center items-center bg-green-600 w-6 h-6 rounded-full m-1 font-bold p-1' onClick={()=> context.setCount(context.count + 1)}>+</div>
            </figure>
